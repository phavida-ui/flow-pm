...
import { createTemplateAction, type ActionState } from "@/app/actions/workflow";

export function NewTemplateDialog() {
  const [open, setOpen] = useState(false);
  const [state, formAction, pending] = useActionState<ActionState, FormData>(createTemplateAction, undefined);
